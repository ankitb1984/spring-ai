 ...
 * @author Geng Rong
 */
@ConfigurationProperties(MoonshotAiCommonProperties.CONFIG_PREFIX)
public class MoonshotAiCommonProperties extends MoonshotAiParentProperties {
	...
	public MoonshotAiCommonProperties() {
