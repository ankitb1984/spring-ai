...
import org.springframework.ai.moonshot.MoonshotAiChatOptions;
...
public class MoonshotAiChatProperties extends MoonshotAiParentProperties {
	...
	public static final String DEFAULT_CHAT_MODEL = MoonshotAiApi.ChatModel.MOONSHOT_V1_8K.getValue();

	private static final Double DEFAULT_TEMPERATURE = 0.7;

	/**
	 * Enable MoonshotAI chat client.
	 */
