...
import org.springframework.ai.moonshot.MoonshotAiTestConfiguration;
 ...
 * @author Geng Rong
 */
@SpringBootTest(classes = MoonshotAiTestConfiguration.class)
@EnabledIfEnvironmentVariable(named = "MOONSHOT_AI_API_KEY", matches = ".+")
class MoonshotAiChatClientIT {

	private static final Logger logger = LoggerFactory.getLogger(MoonshotAiChatClientIT.class);
