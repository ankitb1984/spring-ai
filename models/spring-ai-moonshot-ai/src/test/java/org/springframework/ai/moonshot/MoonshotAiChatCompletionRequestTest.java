...
public class MoonshotAiChatCompletionRequestTest {

	MoonshotAiChatClient chatClient = new MoonshotAiChatClient(new MoonshotAiApi("test"));
	...
	void chatCompletionRequestWithOptionsTest() {
		var options = MoonshotAiChatOptions.builder().withTemperature(0.5f).withTopP(0.8f).build();
